...
registered and the application creates 4 threads :
...
RTOS, ThreadX, USBXDevice, USB_DRD, Full Speed, CDC, HID, VCP, USART, DMA, Mouse.
...
### <b>Hardware and Software environment</b>
  ...
  - The USART2 interface available on PA3 and PA4 of the microcontroller are
