...
extern uint8_t ubActive;
extern uint8_t ubIdle;
...
/* USER CODE BEGIN Tsl_user_SetThresholds */
  ...
  */
  MyTKeys_Param[0].DetectInTh = 255;
  MyTKeys_Param[0].DetectOutTh = 200;
  MyTKeys_Param[0].CalibTh = MyTKeys_Param[0].DetectInTh;

  if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_VREFINT)
  {
    MyTKeys_Param[1].DetectInTh = 160; /* 80 purcents Min delta measure around 200 counts per cycle, limited to 255 as max */
    MyTKeys_Param[1].DetectOutTh = 140; /* 70 purcents Min delta measure around 200 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_3_4VREFINT)
  {
    MyTKeys_Param[1].DetectInTh = 52; /* 80 purcents Min delta measure around 65 counts per cycle */
    MyTKeys_Param[1].DetectOutTh = 45; /* 70 purcents Min delta measure around 65 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_1_2VREFINT)
  {
    MyTKeys_Param[1].DetectInTh = 20; /* 80 purcents Min delta measure around 25 counts per cycle */
    MyTKeys_Param[1].DetectOutTh = 17; /* 70 purcents Min delta measure around 25 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_1_4VREFINT)
  {
    MyTKeys_Param[1].DetectInTh = 6; /* 80 purcents Min delta measure around 8 counts per cycle */
    MyTKeys_Param[1].DetectOutTh = 5; /* 70 purcents Min delta measure around 8 counts per cycle */
  }

  MyTKeys_Param[1].CalibTh = MyTKeys_Param[1].DetectInTh;
