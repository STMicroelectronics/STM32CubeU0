...
#define CHANNEL_1_SRC       (TSC_GROUP6_IDX) /* Index in source register (TSC->IOGXCR[]) */
...
#define BANK_1_MSK_CHANNELS   (CHANNEL_0_IO_MSK | SHIELD_IO_MSK)
#define BANK_1_MSK_GROUPS     (CHANNEL_0_GRP_MSK)
