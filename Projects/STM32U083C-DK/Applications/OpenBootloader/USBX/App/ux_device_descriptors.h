...
#define USBD_DFU_STRING_OB1_DESC                       "@Option Bytes   /0x40022020/01*136 e"

#define USBD_DFU_STRING_OTP_DESC_INDEX                 0x09U
#define USBD_DFU_STRING_OTP_DESC                       "@OTP Memory   /0x1FFF6800/02*01Kg"

#define USBD_DFU_STRING_DEVICE_ID_DESC_INDEX           0x14U
#define USBD_DFU_STRING_DEVICE_ID_DESC                 "@Device ID/0x489,@Revision ID/0x0001"
