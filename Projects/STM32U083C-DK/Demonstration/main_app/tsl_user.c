...
/* USER CODE BEGIN Tsl_user_SetThresholds */
  ...
  */
  ...
  {
    MyTKeys_Param[0].DetectInTh = 57; /* 80 purcents Min delta measure around 70 counts per cycle */
    MyTKeys_Param[0].DetectOutTh = 50; /* 70 purcents Min delta measure around 70 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_3_4VREFINT)
  {
    MyTKeys_Param[0].DetectInTh = 26; /* 80 purcents Min delta measure around 37 counts per cycle */
    MyTKeys_Param[0].DetectOutTh = 23; /* 80 purcents Min delta measure around 37 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_1_2VREFINT)
  {
    MyTKeys_Param[0].DetectInTh = 18; /* 80 purcents Min delta measure around 22 counts per cycle */
    MyTKeys_Param[0].DetectOutTh = 15; /* 70 purcents Min delta measure around 22 counts per cycle */
  }
  else if (hcomp2.Init.InputMinus == COMP_INPUT_MINUS_1_4VREFINT)
  {
    MyTKeys_Param[0].DetectInTh = 6; /* 80 purcents Min delta measure around 7 counts per cycle */
    MyTKeys_Param[0].DetectOutTh = 5; /* 70 purcents Min delta measure around 7 counts per cycle */
  }
