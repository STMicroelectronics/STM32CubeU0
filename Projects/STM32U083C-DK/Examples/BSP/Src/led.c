...
{ 
  ...
  BSP_LCD_GLASS_ScrollSentence((uint8_t *)"      LED3 AND LED4 AND LED5 ON", 1, SCROLL_SPEED_HIGH);
  ...
  /* Turn off the LEDs */ 
  BSP_LCD_GLASS_ScrollSentence((uint8_t *)"      LED3 AND LED4 AND LED5 OFF", 1, SCROLL_SPEED_HIGH);
  BSP_LED_Off(LED3);
  BSP_LED_Off(LED4);
  BSP_LED_Off(LED5);
