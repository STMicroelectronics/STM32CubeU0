...
The STM32U083C-DK board LEDs can be used to monitor the transfer status:  
...
### <b>Directory contents</b>
        ...
        - FLASH/FLASH_EraseProgram/Inc/stm32u083c_discovery_conf.h   BSP configuration file
        - FLASH/FLASH_EraseProgram/Inc/stm32u0xx_hal_conf.h      HAL Configuration file
        - FLASH/FLASH_EraseProgram/Inc/stm32u0xx_it.h            Header for stm32u0xx_it.c
        - FLASH/FLASH_EraseProgram/Inc/main.h                     Header for main.c module
        - FLASH/FLASH_EraseProgram/Src/stm32u0xx_it.c            Interrupt handlers
        - FLASH/FLASH_EraseProgram/Src/main.c                     Main program
        - FLASH/FLASH_EraseProgram/Src/stm32u0xx_hal_msp.c       MSP initialization and de-initialization
        - FLASH/FLASH_EraseProgram/Src/system_stm32u0xx.c        STM32U0xx system clock configuration file
