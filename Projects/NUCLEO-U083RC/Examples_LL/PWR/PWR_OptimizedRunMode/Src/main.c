...
/**
  ...
  *          the core frequency on the fly through the STM32U0xx PWR LL API.
  ******************************************************************************
  * @attention
  *
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_SetPinPull(pb_GPIO_Port, pb_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(pb_GPIO_Port, pb_Pin, LL_GPIO_MODE_INPUT);
