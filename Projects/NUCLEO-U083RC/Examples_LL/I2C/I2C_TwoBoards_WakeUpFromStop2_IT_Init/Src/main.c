...
static void MX_I2C3_Init(void)
{
  ...
  */
  ...
  /* Enable the I2C3 peripheral clock and I2C3 clock source ***************/
   ...
   *  - Set priority for I2C2_3_4_IRQn
   *  - Enable I2C2_3_4_IRQn
   */
...
void Configure_PWR(void)
{
  ...
  /* Optional: Keeping the HSI ON in Stop mode allows to avoid slowing down */
