...
/**
  ******************************************************************************
  * @file    Examples_LL/I2C/I2C_OneBoard_AdvCommunication_DMAAndIT_Init/Src/stm32u0xx_it.c
...
/**
  * @brief This function handles I2C2 + I2C3 global interrupt (combined with EXTI 22) + I2C4 global interrupt.
  */
void I2C2_3_4_IRQHandler(void)
{
  /* USER CODE BEGIN I2C2_3_4_IRQn 0 */
...
else
{
  ...
  /* USER CODE END I2C2_3_4_IRQn 0 */

  /* USER CODE BEGIN I2C2_3_4_IRQn 1 */

  /* USER CODE END I2C2_3_4_IRQn 1 */
}
