...
asynchronously to HyperTerminal (PC) in Interrupt mode (VCP). This example is based on
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Tx_IT_VCP_Init/Inc/stm32u0xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Tx_IT_VCP_Init/Src/stm32u0xx_it.c          Interrupt handlers
  - USART/USART_Communication_Tx_IT_VCP_Init/Src/main.c                  Main program
  - USART/USART_Communication_Tx_IT_VCP_Init/Src/system_stm32u0xx.c      STM32U0xx system source file
