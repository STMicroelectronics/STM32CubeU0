...
asynchronously to an HyperTerminal (PC) in Polling mode (VCP). If the transfer could not
be completed within the allocated time, a timeout allows to exit from the sequence
with a Timeout error code. This example is based on STM32U0xx USART LL API. Peripheral
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Tx_VCP_Init/Inc/stm32u0xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Tx_VCP_Init/Src/stm32u0xx_it.c          Interrupt handlers
  - USART/USART_Communication_Tx_VCP_Init/Src/main.c                  Main program
  - USART/USART_Communication_Tx_VCP_Init/Src/system_stm32u0xx.c      STM32U0xx system source file
