...
from HyperTerminal (PC) in Asynchronous mode using Interrupt mode (VCP). Peripheral initialization is
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Inc/stm32u0xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/stm32u0xx_it.c          Interrupt handlers
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/main.c                  Main program
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/system_stm32u0xx.c      STM32U0xx system source file
