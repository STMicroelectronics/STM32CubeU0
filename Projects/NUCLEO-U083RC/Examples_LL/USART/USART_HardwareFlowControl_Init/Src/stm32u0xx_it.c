...
/**
  ******************************************************************************
  * @file    Examples_LL/USART/USART_HardwareFlowControl_Init/Src/stm32u0xx_it.c
...
void USART2_LPUART2_IRQHandler(void)
{
  ...
  if (LL_USART_IsEnabledIT_TXE(USART2) && LL_USART_IsActiveFlag_TXE(USART2))
  {
    ...
    /* Call function in charge of handling empty $TDREGISTERUC$ => will lead to transmission of next character */
