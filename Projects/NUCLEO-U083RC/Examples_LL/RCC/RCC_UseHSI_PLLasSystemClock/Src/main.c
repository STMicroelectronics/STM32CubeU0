...
#define RCC_FREQUENCY_HIGH         ((uint32_t)48000000) /* High Frequency set to 48MHz*/
...
{
  {RCC_FREQUENCY_LOW,  LL_RCC_PLLM_DIV_8, 16, LL_RCC_PLLR_DIV_8, LL_FLASH_LATENCY_0},
  {RCC_FREQUENCY_HIGH, LL_RCC_PLLM_DIV_2, 24, LL_RCC_PLLR_DIV_4, LL_FLASH_LATENCY_2},
};
...
int main(void)
{
  ...
  {
    /* Problem to enable HSI, blink LED4 */
...
void SystemClock_Config(void)
{
  ...
  LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_MSI, LL_RCC_PLLM_DIV_8, 16, LL_RCC_PLLR_DIV_2);
