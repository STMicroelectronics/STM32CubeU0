...
int main(void)
{
  ...
  /* ---------------------------------------------------------------------------
  TIM1 input clock (TIM1CLK) is set to APB1 clock (PCLK1), since APB1   prescaler is 1.
    TIM1CLK = PCLK1
    PCLK1 = HCLK
  ...
  value defined by the aCCValue_Buffer.
    ...
    Note:
     SystemCoreClock variable holds HCLK frequency and is defined in system_stm32u0xx.c file.
