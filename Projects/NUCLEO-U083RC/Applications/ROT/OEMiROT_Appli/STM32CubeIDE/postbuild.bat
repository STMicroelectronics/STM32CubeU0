...
set code_bin="%projectdir%%config%\NUCLEO-U083RC_OEMiROT_Appli.bin"
set code_dest_bin="%projectdir%\..\Binary\rot_app.bin"
...
copy %code_bin% %code_dest_bin% >> %current_log_file% 2>&1
IF !errorlevel! NEQ 0 goto :error
