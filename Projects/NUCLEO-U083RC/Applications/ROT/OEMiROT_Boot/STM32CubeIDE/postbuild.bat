...
set postbuild_file="%appli_dir%\STM32CubeIDE\postbuild.bat"
...
set appli_linker_file="%appli_dir%\STM32CubeIDE\STM32U083RCIX_FLASH.ld"
set loader_linker_file="%loader_dir%\STM32CubeIDE\STM32U083RCIX_FLASH.ld"
...
copy %projectdir%%config%\NUCLEO-U083RC_OEMiROT_Boot.bin  %projectdir%\..\Binary\OEMiROT_Boot.bin >> %current_log_file% 2>&1
IF !errorlevel! NEQ 0 goto :error
