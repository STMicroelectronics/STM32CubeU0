...
enum image_attributes
{
  ...
  RE_INIT_IMAGE_PARTITION_OFFSET = (FLASH_AREA_0_OFFSET),
  RE_INIT_IMAGE_PARTITION_ADDRESS = (FLASH_BASE_ADDRESS + FLASH_AREA_0_OFFSET),
#if (MCUBOOT_DATA_IMAGE_NUMBER == 1)
  RE_DATA_IMAGE_PARTITION_OFFSET = (FLASH_AREA_5_OFFSET),
  RE_DATA_IMAGE_PARTITION_ADDRESS = (FLASH_BASE_ADDRESS + FLASH_AREA_5_OFFSET),
  RE_INIT_DATA_IMAGE_PARTITION_OFFSET = (FLASH_AREA_5_OFFSET),
  RE_INIT_DATA_IMAGE_PARTITION_ADDRESS = (FLASH_BASE_ADDRESS + FLASH_AREA_5_OFFSET),
#endif /* (MCUBOOT_DATA_IMAGE_NUMBER == 1) */
#else
  RE_PRIMARY_ONLY = (0x0),
