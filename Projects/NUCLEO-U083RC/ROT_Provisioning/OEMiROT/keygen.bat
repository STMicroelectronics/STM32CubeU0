...
set "command_key=%imgtool% keygen -k %key_ecc% -t ecdsa-p256"
%command_key%
IF !errorlevel! NEQ 0 goto :error_key
set "command_key=%imgtool% getpub -k %key_ecc%  > %keys_c%"
%command_key%
IF !errorlevel! NEQ 0 goto :error_key
...
%command_key%
IF !errorlevel! NEQ 0 goto :error_key
set "command_key=%imgtool% getpriv  --minimal -k %key_ecc_enc_priv%  >> %keys_c%"
%command_key%
IF !errorlevel! NEQ 0 goto :error_key
echo Script success!
cmd /k
